...
//  ;
  ...
  .def(init<bool>())
  .def("connect", (void (UaClient::*)(const std::string &, const ReconnectCb &)) &UaClient::Connect)
  .def("connect", (void (UaClient::*)(const EndpointDescription &, const ReconnectCb &)) &UaClient::Connect)
